    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('2', 'Female'), ('1', 'Male'), ('3', 'Other')], max_length=1)),
                ...
                ('user_type', models.CharField(choices=[('1', 'User'), ('2', 'NFN Worker'), ('3', 'NFN Leader'), ('4', 'NFN Admin')], default='1', max_length=1)),
